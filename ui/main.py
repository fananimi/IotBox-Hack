...
"}"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.txtPort.setText(_translate("Dialog", "None", None))
        self.txtPrinterLabel.setText(_translate("Dialog", "Disconnected", None))
        self.txtPrinterThermal.setText(_translate("Dialog", "Disconnected", None))
